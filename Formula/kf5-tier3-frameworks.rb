...
class Kf5Tier3Frameworks < Formula
  ...
  depends_on "ansatzX/homebrew-kde/kf5-kded"
  depends_on "ansatzX/homebrew-kde/kf5-kemoticons"
  depends_on "ansatzX/homebrew-kde/kf5-kglobalaccel"
  ...
  depends_on "ansatzX/homebrew-kde/kf5-ktextwidgets"
  depends_on "ansatzX/homebrew-kde/kf5-kwallet"
  depends_on "ansatzX/homebrew-kde/kf5-kxmlgui"
  depends_on "ansatzX/homebrew-kde/kf5-tier2-frameworks"
