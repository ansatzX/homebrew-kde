...
class Kf5Tier2Frameworks < Formula
  ...
  depends_on "ansatzX/homebrew-kde/kf5-kauth"
  ...
  depends_on "ansatzX/homebrew-kde/kf5-kimageformats"
  depends_on "ansatzX/homebrew-kde/kf5-kjobwidgets"
  depends_on "ansatzX/homebrew-kde/kf5-knotifications"
  depends_on "ansatzX/homebrew-kde/kf5-kpackage"
  depends_on "ansatzX/homebrew-kde/kf5-kpeople"
  depends_on "ansatzX/homebrew-kde/kf5-kpty"
  depends_on "ansatzX/homebrew-kde/kf5-kunitconversion"
  depends_on "ansatzX/homebrew-kde/kf5-tier1-frameworks"
