...
class Kf5PortingaidsFrameworks < Formula
  ...
  depends_on "ansatzX/homebrew-kde/kf5-kdesignerplugin"
  depends_on "ansatzX/homebrew-kde/kf5-kdewebkit"
  depends_on "ansatzX/homebrew-kde/kf5-khtml"
  depends_on "ansatzX/homebrew-kde/kf5-kjs"
  depends_on "ansatzX/homebrew-kde/kf5-kjsembed"
  depends_on "ansatzX/homebrew-kde/kf5-kmediaplayer"
  depends_on "ansatzX/homebrew-kde/kf5-kross"
  depends_on "ansatzX/homebrew-kde/kf5-kxmlrpcclient"
  depends_on "ansatzX/homebrew-kde/kf5-tier4-frameworks"
