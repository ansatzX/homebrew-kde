...
class Kf5Tier1Frameworks < Formula
  ...
  depends_on "karchive"
  depends_on "ansatzX/homebrew-kde/kf5-attica"
  ...
  depends_on "ansatzX/homebrew-kde/kf5-kdnssd"
  depends_on "ansatzX/homebrew-kde/kf5-kguiaddons"
  ...
  depends_on "ansatzX/homebrew-kde/kf5-kitemviews"
  depends_on "ansatzX/homebrew-kde/kf5-kplotting"
  depends_on "ansatzX/homebrew-kde/kf5-kwidgetsaddons"
  depends_on "ansatzX/homebrew-kde/kf5-kwindowsystem"
  depends_on "ansatzX/homebrew-kde/kf5-qqc2-desktop-style"
