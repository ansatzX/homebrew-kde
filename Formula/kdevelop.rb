...
class Kdevelop < Formula
  ...
  depends_on "ansatzX/homebrew-kde/kdevelop-pg-qt" => :build
  ...
  depends_on "cmake"
  depends_on "cppcheck"
  depends_on "ansatzX/homebrew-kde/grantlee"
  ...
  depends_on "ansatzX/homebrew-kde/ksysguard"
  depends_on "ansatzX/homebrew-kde/libkomparediff2"
  depends_on "ansatzX/homebrew-kde/qt-webkit"
  depends_on "llvm"
  ...
  conflicts_with "ansatzX/homebrew-kde/kdevplatform", because: "now included in Kdevelop"
